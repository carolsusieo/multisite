...
/* END managing ITEMS*/
     ...
     aStyle = (name) => {
       ...
       var currentStyle = {}
       var i = 0;
          for(i = 0; i < this.state.appConfig.articles.length;i++){
  ...
  //        console.log(type, imageIn)
      ...
      else if(imageIn != undefined && currentStyle.background == undefined){
        if(currentStyle.backgroundHold != undefined && currentStyle.backgroundHold.includes("url")){
          currentStyle.background = currentStyle.backgroundHold + imageIn + ")";
        }
        else if(currentStyle.backgroundHold != undefined){
          currentStyle.background = currentStyle.backgroundHold;
        }
