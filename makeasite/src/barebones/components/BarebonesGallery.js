...
class BarebonesGallery extends Component {
  constructor(props) {
    super(props);
    this.state = {
      photos: null,
      activePhotoIndex: props.activePhotoIndex,
...
//    console.log("update current ", current);
    this.setState({activePhotoIndex: current});
    this.state.updateCurrent(current);
  }
...
/*
  ...
  close() {
    ...
    this.state.onClose(this.state.activePhotoIndex);
  }
*/
...
BarebonesGallery.propTypes = propTypes;
BarebonesGallery.defaultProps = defaultProps;

export default BarebonesGallery;
/*
<Portal>
  <FocusTrap>
    <div
...
/*
  <CloseButton
    onPress={this.close}
    currentWindow = {activePhotoIndex}
    light={light}
  />
  */
